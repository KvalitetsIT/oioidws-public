...
public class ChildrenInCustodyUnitTest {
	...
	public void testParseWorks() throws ValidationException {
		...
		String stringECPR = "urn:dk:healthcare:saml:attribute:ECprNumberIdentifier:151298049F";
		...
		assertEquals("urn:dk:healthcare:saml:attribute:ECprNumberIdentifier", cic2.getCprType().getValue());
	...
	public void testInvalidDate2() throws ValidationException {
		String stringECPR = "urn:dk:healthcare:saml:attribute:ECprNumberIdentifier:153298049F";
