...
import dk.sds.sts.providers.CustomSubjectBean;
...
public final class SAML2ComponentBuilder {
    ...
    public static Subject createSaml2Subject(SubjectBean subjectBean)
        ...
        // ADDED: extra check
        if (subjectBean instanceof CustomSubjectBean) {
	        NameID nameID2 = SAML2ComponentBuilder.createSubjectConfirmationNameID((CustomSubjectBean) subjectBean);
    ...
    // ADDED: new method
    private static NameID createSubjectConfirmationNameID(CustomSubjectBean subject) {
        NameIDBean nameIDBean = new NameIDBean();
        nameIDBean.setNameIDFormat(subject.getSubjectConfirmationNameIDFormat());
        nameIDBean.setNameValue(subject.getSubjectConfirmationNameIDValue());
